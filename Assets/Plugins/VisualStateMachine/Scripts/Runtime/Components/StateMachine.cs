namespace Ilumisoft.VisualStateMachine
{
    ...
    public class StateMachine : MonoBehaviour
    {
        ...
        /// <summary>
        /// Sets the condition that must return true in order to transition to the target state.
        /// </summary>
        /// <param name="id">The name of the transition.</param>
        /// <param name="condition">The condition delegate that will be checked each frame.</param>
        ...
        /// Sets the condition that must return true in order to transition to the target state.
        /// </summary>
        /// <param name="label">The label of the transitions.</param>
        /// <param name="condition">The condition delegate that will be checked each frame.</param>
        public void SetTransitionConditionByLabel(string label, Condition condition)
        {
            foreach (var transition in graph.Transitions)
