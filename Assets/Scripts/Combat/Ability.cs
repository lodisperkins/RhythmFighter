...
namespace Combat
{
    ...
    public abstract class Ability
    {
        ...
        /// <summary>
        /// Initializes colliders, data and owner for abilties.
        /// </summary>
        /// <param name="owner">The game object that is going to be using this ability.</param>
        /// <param name="data">The stats for this ability.</param>
        ...
        /// <summary>
        /// Gets the information of a collider from the ability data.
        /// </summary>
        /// <param name="index">The index of the ability data collider info.</param>
        ...
        private void RecoverPhase(params object[] args)
        {
            ...
            _currentTimer = CoroutineManager.Instance.StartNewTimedAction(arguments => EndAbility(args), TimeUnit.SCALEDTIME, AbilityData.RecoverTime);
        }

        public void EndAbility(params object[] args)
        {
        ...
        /// <summary>
        /// Called before this move is active.
        /// </summary>
        /// <param name="args"></param>
        protected virtual void OnStart(params object[] args) { }
        /// <summary>
        /// Called when the object is performing the ability action.
        /// </summary>
        /// <param name="args"></param>
        protected virtual void OnActivate(params object[] args) { }
        /// <summary>
        /// Called when the object is return to neutral state after performing the action.
        /// </summary>
        /// <param name="args"></param>
        protected virtual void OnRecover(params object[] args) { }
        /// <summary>
        /// Called when the object returns to neutral state.
        /// </summary>
        /// <param name="args"></param>
        protected virtual void OnEnd(params object[] args) { }
