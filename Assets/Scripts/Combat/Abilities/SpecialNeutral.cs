...
namespace Combat
{
    ...
    /// </summary>
    public class SpecialNeutral : Ability
    {
        ...
        {
            _height = AbilityData.GetCustomStatValue("Hitbox Height");
        ...
        protected override void OnActivate(params object[] args)
        {
            ...
            Vector3 spawnPosition = Owner.transform.position + Owner.transform.up * _height;
